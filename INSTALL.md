...
> **요약**: 미서명 테스트 빌드는 최초 실행 시 손상 경고가 뜰 수 있으며,
> `xattr -cr` 또는 우클릭 → 열기로 실행 가능합니다. 정식 배포는 Apple
> Developer ID 서명 + notarization을 적용해 이 절차가 필요 없도록 만들
> 예정입니다 (RC-QA.md §4 P1).
...
보호 장치를 발동한 것뿐입니다. 베타 테스터가 보고한 케이스에서는 아래의
"방법 1 우클릭 → 열기" 또는 "방법 3 xattr -cr"로 정상 실행이 확인되었
습니다.
